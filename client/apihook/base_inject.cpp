...
BYTE load_library_x86[] =	"\xfc\xe8\x89\x00\x00\x00\x60\x89\xe5\x31"
							...
							"\x12\xeb\x86\x5d\x8d\x85\xb7\x00\x00\x00"
							"\x50\x68\x4c\x77\x26\x07\xff\xd5\xbb\xe0"
							"\x1d\x2a\x0a\x68\xa6\x95\xbd\x9d\xff\xd5"
							"\x3c\x06\x7c\x0a\x80\xfb\xe0\x75\x05\xbb"
							"\x47\x13\x72\x6f\x6a\x00\x53\xff\xd5";
// see loadlibrary64.asm
BYTE load_library_x64[] =	"\xfc\x48\x83\xe4\xf0\xe8\xc8\x00\x00\x00"
							...
							"\x20\x8b\x42\x3c\x48\x01\xd0\x66\x81\x78"
							"\x18\x0b\x02\x75\x72\x8b\x80\x88\x00\x00"
							"\x00\x48\x85\xc0\x74\x67\x48\x01\xd0\x50"
							"\x8b\x48\x18\x44\x8b\x40\x20\x49\x01\xd0"
							"\xe3\x56\x48\xff\xc9\x41\x8b\x34\x88\x48"
							"\x01\xd6\x4d\x31\xc9\x48\x31\xc0\xac\x41"
							"\xc1\xc9\x0d\x41\x01\xc1\x38\xe0\x75\xf1"
							"\x4c\x03\x4c\x24\x08\x45\x39\xd1\x75\xd8"
							"\x58\x44\x8b\x40\x24\x49\x01\xd0\x66\x41"
							"\x8b\x0c\x48\x44\x8b\x40\x1c\x49\x01\xd0"
							"\x41\x8b\x04\x88\x48\x01\xd0\x41\x58\x41"
							"\x58\x5e\x59\x5a\x41\x58\x41\x59\x41\x5a"
							"\x48\x83\xec\x20\x41\x52\xff\xe0\x58\x41"
							"\x59\x5a\x48\x8b\x12\xe9\x4f\xff\xff\xff"
							"\x5d\x67\x48\x8d\x8d\x00\x01\x00\x00\x41"
							"\xba\x4c\x77\x26\x07\xff\xd5\xbb\xe0\x1d"
							"\x2a\x0a\x41\xba\xa6\x95\xbd\x9d\xff\xd5"
							"\x48\x83\xc4\x28\x3c\x06\x7c\x0a\x80\xfb"
							"\xe0\x75\x05\xbb\x47\x13\x72\x6f\x6a\x00"
							"\x59\x41\x89\xda\xff\xd5";
...
BOOL injectPrep(){
	...
	if(loadDllx86Code == NULL)
		return FALSE;
	memcpy(loadDllx86Code, load_library_x86, sizeof(load_library_x86) - 1);
	memcpy(loadDllx86Code + sizeof(load_library_x86) - 1, shortDllPath, 
			loadDllx86CodeSize - sizeof(load_library_x86) + 1);

	//Get 64 bit DLL path
	for(size = lstrlenA(filename); filename[size] != '\\' && size != 0; size--)
		filename[size] = 0;
	strcat_s(filename,"apihook64.dll");
	GetShortPathNameA(filename, shortDllPath, sizeof(shortDllPath));

	//Get 64 bit loadlibrary
	loadDllx64CodeSize = sizeof(load_library_x64) + lstrlenA(shortDllPath);
	loadDllx64Code = (PBYTE)HeapAlloc(rwHeap, 0, loadDllx64CodeSize);
	if(loadDllx64Code == NULL)
		return FALSE;
	memcpy(loadDllx64Code, load_library_x64, sizeof(load_library_x64) - 1);
	memcpy(loadDllx64Code + sizeof(load_library_x64) - 1, shortDllPath, 
